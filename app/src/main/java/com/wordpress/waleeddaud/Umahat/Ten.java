...
public class Ten extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Rammla);
        int article_Selector=10;
        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_J);
        recyclerView.setLayoutManager(new GridLayoutManager(this,2,GridLayoutManager.VERTICAL,false));
        Ten_Adapter adapter=new Ten_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
