...
public class Nine extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Safiia);
        int article_Selector=9;

        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_I);
        recyclerView.setLayoutManager(new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false));
        Nine_Adapter adapter=new Nine_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
