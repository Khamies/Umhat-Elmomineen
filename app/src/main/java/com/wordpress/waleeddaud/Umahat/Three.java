...
public class Three extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Isha);
        int article_Selector=3;
        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_C);
        recyclerView.setLayoutManager(new GridLayoutManager(this,2,GridLayoutManager.VERTICAL,false));
        Three_Adapter adapter=new Three_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
