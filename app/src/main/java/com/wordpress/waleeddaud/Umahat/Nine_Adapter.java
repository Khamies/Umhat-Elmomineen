 ...
 */
public class Nine_Adapter  extends RecyclerView.Adapter<Nine_Adapter.Linker> {
    ...
    public Nine_Adapter(List<Contents_Data> data,ArrayList<Class<?>>articles_container,
    ...
    public void onBindViewHolder(Linker holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Safiia",articles_data[position]);
