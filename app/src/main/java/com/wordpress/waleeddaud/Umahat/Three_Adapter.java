 ...
 */
public class Three_Adapter  extends RecyclerView.Adapter<Three_Adapter.Linker> {
    ...
    public Three_Adapter(List<Contents_Data> data,ArrayList<Class<?>>articles_container,
    ...
    public void onBindViewHolder(Linker holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Isha",articles_data[position]);
