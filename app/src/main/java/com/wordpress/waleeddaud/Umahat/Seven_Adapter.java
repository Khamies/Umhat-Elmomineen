 ...
 */
public class Seven_Adapter  extends RecyclerView.Adapter<Seven_Adapter.Linker> {
    ...
    public Seven_Adapter(List<Contents_Data> data,ArrayList<Class<?>>articles_container,
    ...
    public void onBindViewHolder(Linker holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Zainab_2", articles_data[position]);
