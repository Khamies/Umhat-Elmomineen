...
public class Two extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Sawda);
        int article_Selector=2;
        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_B);
        recyclerView.setLayoutManager(new GridLayoutManager(this,2,GridLayoutManager.VERTICAL,false));
        Two_Adapter adapter=new Two_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
