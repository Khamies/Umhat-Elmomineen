...
public class Four extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Hafsa);
        int article_Selector=4;

        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_D);
        recyclerView.setLayoutManager(new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false));
        Four_Adapter adapter=new Four_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
