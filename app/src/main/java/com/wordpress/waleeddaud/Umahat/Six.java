...
public class Six extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Umsalama);
        int article_Selector=6;

        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_F);
        recyclerView.setLayoutManager(new GridLayoutManager(this,2,GridLayoutManager.VERTICAL,false));
        Six_Adapter adapter=new Six_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
