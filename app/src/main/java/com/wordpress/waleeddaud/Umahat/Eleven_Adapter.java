...
import com.wordpress.waleeddaud.Chapter_two.Contents_Adapter;
 ...
 */
public class Eleven_Adapter  extends RecyclerView.Adapter<Eleven_Adapter.Linker> {
    ...
    public Eleven_Adapter(List<Contents_Data> data,ArrayList<Class<?>>articles_container,
    ...
    public void onBindViewHolder(Linker holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Mimona",articles_data[position]);
