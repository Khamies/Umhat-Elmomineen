 ...
 */
public class Two_Adapter  extends RecyclerView.Adapter<Two_Adapter.Linker> {
    ...
    public Two_Adapter(List<Contents_Data> data,ArrayList<Class<?> >articles_container,
    ...
    public void onBindViewHolder(Linker holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("sawda",articles_data[position]);
