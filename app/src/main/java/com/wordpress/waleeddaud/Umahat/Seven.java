...
public class Seven extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Zainab_2);
        int article_Selector=7;

        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_G);
        recyclerView.setLayoutManager(new GridLayoutManager(this,2,GridLayoutManager.VERTICAL,false));
        Seven_Adapter adapter=new Seven_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
