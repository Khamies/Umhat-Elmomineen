 ...
 */
public class Ten_Adapter  extends RecyclerView.Adapter<Ten_Adapter.Linker> {
    ...
    public Ten_Adapter(List<Contents_Data> data,ArrayList<Class<?>>articles_container,
    ...
    public void onBindViewHolder(Linker holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Rammla",articles_data[position]);
