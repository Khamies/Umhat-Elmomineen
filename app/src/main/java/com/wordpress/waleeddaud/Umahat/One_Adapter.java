 ...
 */
public class One_Adapter  extends RecyclerView.Adapter<One_Adapter.Linker> {
    ...
    int selector;
        ...
        public One_Adapter(List<Contents_Data> data,ArrayList<Class<?>> articles_container,
        ...
        public void onBindViewHolder(Linker holder, final int position) {
            ...
            holder.text.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("khadija",articles_data[position]);
