 ...
 */
public class Eight_Adapter  extends RecyclerView.Adapter<Eight_Adapter.Linker> {
    ...
    public Eight_Adapter(List<Contents_Data> data,ArrayList<Class<?>>articles_container,
    ...
    public void onBindViewHolder(Linker holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Gawiria",articles_data[position]);
