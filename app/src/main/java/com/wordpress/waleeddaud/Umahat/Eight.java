...
public class Eight extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Gawiria);
        int article_Selector=8;

        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_H);
        recyclerView.setLayoutManager(new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false));
        Eight_Adapter adapter=new Eight_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
