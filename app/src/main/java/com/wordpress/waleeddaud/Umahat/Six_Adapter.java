 ...
 */
public class Six_Adapter  extends RecyclerView.Adapter<Six_Adapter.Linker> {
    ...
    public Six_Adapter(List<Contents_Data> data,ArrayList<Class<?>>articles_container,
    ...
    public void onBindViewHolder(Linker holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Umsalama",articles_data[position]);
