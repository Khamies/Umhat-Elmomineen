...
public class Five extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] articles_data=getResources().getStringArray(R.array.Zainab_1);
        int article_Selector=5;

        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recycleview_E);
        recyclerView.setLayoutManager(new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false));
        Five_Adapter adapter=new Five_Adapter(charge_Content(),Article_Containers(),articles_data,article_Selector);
